  ...
  return (
    <>
      ...
      <CForm onSubmit={submitHandler}>
        <CRow className="storeDetailsForm">
          <CCol md={3}>
            <CFormLabel htmlFor="storeName" className="col-form-label">
              Store Name
            </CFormLabel>
            <CFormInput
          ...
          <CCol md={3}>
            <CFormLabel htmlFor="License" className="col-form-label">
              License
            </CFormLabel>
            <CFormInput
              placeholder="Please enter liscense"
              aria-label="hireFor"
              name="license"
              id="license"
        ...
        <CRow className="flex-align-left">
          <CCol md={12} className="">
            <CButton type="reset" placement="right" className="custom-blue-btn-outline">
              Cancel
            </CButton>
            <CButton type="submit" color="danger" className="custom-blue-btn">
              Submit
            </CButton>
          </CCol>
          {/* <CCol md={6} className="">
