    ...
    <> 
        ...
        <CRow>
            <CCol md={6}>
                ...
                <CFormInput placeholder="Please enter your name" aria-label="Name"  name="name" id="name" onChange={(e) => setName(e.target.value)}/>
            </CCol>
            <CCol md={6}>
                <CFormLabel htmlFor="email" className="col-sm-2 col-form-label">Email</CFormLabel>
                <CFormInput placeholder="Please enter your email" aria-label="Eamil"  name="email" id="email" onChange={(e) => setEmail(e.target.value)}/>
            </CCol>
            <CCol md={6}>
                <CFormLabel htmlFor="phone" className="col-form-label">Phone Number</CFormLabel>
                <CFormInput placeholder="Please enter your name" aria-label="Phone Number" name="phone" id="phone" onChange={(e) => setPhone(e.target.value) }/>
            </CCol>
        </CRow>
        ...
        <CRow>
            <CCol md={6}>
                ...
                <CFormInput placeholder="Please enter your username" aria-label="Username"  name="username" id="username" onChange={(e) => setUsername(e.target.value) }/>
            </CCol>
            <CCol md={6}>
            ...
            <CCol md={6}>
                ...
                <CFormInput type="password" placeholder="Please enter your Pasword" aria-label="First name" name="password" id="password" onChange={(e) => setPassword(e.target.value) }/>
            </CCol>
            <CCol md={6}>
                <CFormLabel htmlFor="confirmPassword" className="col-form-label">Confirm Password</CFormLabel>
                <CFormInput type="password" placeholder="Please enter your confirm Passsword" aria-label="Confirm Password" name="confirmPassword" id="confirmPassword" onChange={(e) => setConfirmPassword(e.target.value) }/>
            </CCol>
        </CRow>
        <CRow className='mt-4'>
            <CCol md={6} >
